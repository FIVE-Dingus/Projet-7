    ...
    <div class="row">
        ...
        <div class="col l9">
            <div class="container_droit grey-background col l12" style="margin-bottom: 50px;">
                ...
                <div class="stats col l3 s11 offset-s1" style="background : linear-gradient(to right, #4f46ba, #84e8f4);">
                    <h4>Views:</h4>
                </div>
                <div class="stats col l3 s11 offset-l1 offset-s1" style="background : linear-gradient(to right, #4f46ba, #84e8f4);">
                    <div class="col l5">
                        <h4>Articles:</h4>
                    </div>
                ...
                <ul class="collapsible post">
                    <li>
                        ...
                        <div class="collapsible-body">
                            <ul class="deroulant" style=" background-color: #FBFBFB; width: 100%; z-index: 1000; padding: 0px;">
            ...
            <div class="col s6">
                <ul class="collapsible users">
                    <li>
                        <div class="collapsible-header"><i class="material-icons">arrow_drop_down</i>ajouter post</div>
                        <div class="collapsible-body">
                            <ul class="deroulant" style=" background-color: #FBFBFB; width: 100%; z-index: 1000; padding: 0px;">
                                <li><a href="#actu" class="waves-effect waves-light white btn modal-trigger" style="margin-bottom: 25px;"><i class="material-icons">add</i> Dernières Actualités </a></li>
                                <li><a href="#campus" class="waves-effect waves-light white btn modal-trigger" style="margin-bottom: 25px;"><i class="material-icons">add</i> Actu Campus</a></li>
                                <li><a href="#asso" class="waves-effect waves-light white btn modal-trigger" style="margin-bottom: 25px;"><i class="material-icons">add</i> Actu Vie Associative</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
